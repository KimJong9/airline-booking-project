...
function BookingSection() {
    ...
    // 출발지 나라 목록 불러오기
    useEffect(() => {
        axios.get('${apiUrl}/flight/countries')
    ...
    useEffect(() => {
        if (selectedDepartureCountry) {
            axios.get(`${apiUrl}/flight/cities/${selectedDepartureCountry}`)
    ...
    useEffect(() => {
        if (selectedArrivalCountry) {
            axios.get(`${apiUrl}/flight/cities/${selectedArrivalCountry}`)
    ...
    useEffect(() => {
        if (selectedDepartureCity) {
            axios.get(`${apiUrl}/flight/airports/${selectedDepartureCountry}/${selectedDepartureCity}`)
    ...
    useEffect(() => {
        if (selectedArrivalCity) {
            axios.get(`${apiUrl}/flight/airports/${selectedArrivalCountry}/${selectedArrivalCity}`)
