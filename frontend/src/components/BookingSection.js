...
function BookingSection() {
    ...
    useEffect(() => {
        if (selectedDepartureCountry) {
            axios.get(`http://localhost:5001/api/cities/${selectedDepartureCountry}`)
    ...
    useEffect(() => {
        if (selectedArrivalCountry) {
            axios.get(`http://localhost:5001/api/cities/${selectedArrivalCountry}`)
    ...
    useEffect(() => {
        if (selectedDepartureCity) {
            axios.get(`http://localhost:5001/api/airports/${selectedDepartureCountry}/${selectedDepartureCity}`)
    ...
    useEffect(() => {
        if (selectedArrivalCity) {
            axios.get(`http://localhost:5001/api/airports/${selectedArrivalCountry}/${selectedArrivalCity}`)
