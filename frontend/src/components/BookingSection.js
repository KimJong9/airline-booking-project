...
function BookingSection() {
    ...
    // 출발지 나라 목록 불러오기
    useEffect(() => {
        axios.get('https://api.jawsfly.net/search/countries')
    ...
    useEffect(() => {
        if (selectedDepartureCountry) {
            axios.get(`https://api.jawsfly.net/search/cities/${selectedDepartureCountry}`)
    ...
    useEffect(() => {
        if (selectedArrivalCountry) {
            axios.get(`https://api.jawsfly.net/search/cities/${selectedArrivalCountry}`)
    ...
    useEffect(() => {
        if (selectedDepartureCity) {
            axios.get(`https://api.jawsfly.net/search/airports/${selectedDepartureCountry}/${selectedDepartureCity}`)
    ...
    useEffect(() => {
        if (selectedArrivalCity) {
            axios.get(`https://api.jawsfly.net/search/airports/${selectedArrivalCountry}/${selectedArrivalCity}`)
    ...
    const handleSearch = () => {
        ...
        axios.get(`https://api.jawsfly.net/search/flights`, {
            params: {
