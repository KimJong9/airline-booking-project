...
function BookingSection() {
    ...
    // 출발지 나라 목록 불러오기
    useEffect(() => {
        axios.get('https://alb.heroic.today/flight/countries')
    ...
    useEffect(() => {
        if (selectedDepartureCountry) {
            axios.get(`https://alb.heroic.today/flight/cities/${selectedDepartureCountry}`)
    ...
    useEffect(() => {
        if (selectedArrivalCountry) {
            axios.get(`https://alb.heroic.today/flight/cities/${selectedArrivalCountry}`)
    ...
    useEffect(() => {
        if (selectedDepartureCity) {
            axios.get(`https://alb.heroic.today/flight/airports/${selectedDepartureCountry}/${selectedDepartureCity}`)
    ...
    useEffect(() => {
        if (selectedArrivalCity) {
            axios.get(`https://alb.heroic.today/flight/airports/${selectedArrivalCountry}/${selectedArrivalCity}`)
